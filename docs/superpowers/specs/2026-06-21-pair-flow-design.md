...
│       │   ├── ...
│       │   ├── ...（B 确认后 advance，见 §5.3 "advance 前置条件"）
...
{
  "schema_version": 1,
  "workflow_id": null,          // confirm_task 时生成
  "next_issue_id": 1,
  ...
  "round": 1,
  "turn": "idle | <identity>",
  "turn_switched_at": null,    // turn 切换时间戳
  "turn_claimed_at": null,     // claim_turn 时间戳
  "converged": false,
  ...
  "history": [
    {
      "type": "phase_change | submit | advance",
      "timestamp": "ISO8601",
      "details": { ... }
    }
  ],
...
双方在产出文档中通过标注提出人管理观点差异。不需要独立的 issue 跟踪系统。
