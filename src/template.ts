...
export function getTemplate(state: PairFlowState, isReviewer?: boolean): string {
...
function docUpdateSection(isReviewer?: boolean): string {
  if (isReviewer) {
    return `## 文档更新确认
- 检查对方产出是否需要配套文档更新：<是/否>
- 对方是否已更新文档：<是/否>
- 如未更新，追问理由：<说明>`;
  }
  return `## 文档更新确认
